...
@endif
 ...
 {{ csrf_field() }}
    ...
    <input type="text" required id="name" value="{{ $usuario->name}}" name="name" class="form-control validate">
...
<div class="form-row">
    ...
    <input type="password" required id="password" value="" name="password" class="form-control validate">
...
@if ($errors->has('password'))
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <input type="password" required id="password_confirmation" value="" name="password_confirmation" class="form-control validate">
...
@if ($errors->has('password_confirmation'))
  ...
  <div class="form-row">
    ...
    <input type="email" required id="email" value="{{ $usuario->email}}" name="email" class="form-control validate">
